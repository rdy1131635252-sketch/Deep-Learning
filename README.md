...
怎么打开
由于使用 动态加载章节文件，不能直接双击 index.html（浏览器的 file:// 协议会拦截 fetch）。 需要通过本地 HTTP 服务器打开：fetch()
...
CNN （4.1-4.2） — 积卷原理 / 8 种经典架构（LeNet， AlexNet， VGG， GoogLeNet， ResNet， MobileNet， EfficientNet， ViT）
